...
(* OASIS_START *)
(* DO NOT EDIT (digest: da188e520456f6afb9f685fb6f946956) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules =
                        ["Bits"; "Misc"; "ModComposition"; "GroupTable0x04"];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("packet", None);
                           InternalLibrary "openflow";
                           InternalLibrary "async_openflow"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "8\015\242\158\210\n23G\177O\202\206\208\1458";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
